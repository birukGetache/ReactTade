    ...
    return (
        <Home>
            <SideBar>
                ...
                <div>
                {showhumberger == true ? <FaBars style={{color:"white" , fontSize:"20px", position:"absolute" , top:"130px" , right:"-5px" }} onClick={hums}></FaBars>: <FaTimes style={{color:"white" , fontSize:"20px" , position:"absolute" , top:"130px" , right:"-5px" }} onClick={hums}></FaTimes>}
