            ...
            >
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "16px" }}>
                    {cartsItem.map((item) => (
                        ...
                        >
                            <h3 style={{ borderBottom: "1px solid #f0f0f0", paddingBottom: "8px", marginBottom: "16px" }}>
                                {item.name}
                            </h3>
    ...
    {!isMediumOrLarger ? (
      ...
      />
        ...
        />
            ...
            {clicked == 28 &&<div>
              <Layout style={{ padding: '20px' , height:"100vh" , position:"absolute", top:"0%" , bottom:"0%", right:"0%",left:"0%", background:"black", boxSizing:"border-box" , overflow:"auto" , height:"auto",  backgroundColor: "rgba(0, 0, 0, 0.7)"}}>
                
      <Content style={{ fontFamily: '"DM Sans", sans-serif', color: textColor  ,borderRadius:"50px" , display:"flex" , alignItems:"center" , justifyContent:"center" , borderRadius:"50px"}}>
        <p style={{color:"white" , fontSize:"30px" , float:"right" , cursor:"pointer" , position:"absolute" , top:"10px " , right:"10px"}} onClick={()=>dispatch(toggleClicked(2))}>&times;</p>
     
            <div style={{ padding: '20px',backgroundColor:"white" , display:"flex"  , alignItems:"center" , flexDirection:"column" , borderRadius:"50px" }}>
